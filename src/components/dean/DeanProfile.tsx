        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1">
                <Badge variant={profile.is_active || profile.active || profile.isActive ? "secondary" : "destructive"}
                       className={profile.is_active || profile.active || profile.isActive ? "bg-green-100 text-green-800" : ""}>
                  {profile.is_active || profile.active || profile.isActive ? 'Active' : 'Inactive'}
                </Badge>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center mt-1">
                ...
                <p className="text-sm text-muted-foreground">
                  {(() => {
                    const raw = profile.date_joined || profile.joined_at || profile.created_at || profile.date_joined_at;
                    try {
